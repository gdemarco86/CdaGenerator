...
public class CD
    extends ANY implements Cloneable
{
    ...
    public CD copia()
    {
        ...
        try {
            nuovo = (CD) this.clone();
            nuovo.setOriginalText(nuovo.getOriginalText().copia());
    ...
    public void setTranslation(List<CD> traslations) {
        this.translation = traslations;
    }
