...
/**
 * <p>
 * Classe Java per POCD_MT000040.Entry complex type.
 *
 * <p>
 ...
 *         &lt;choice>
 *           &lt;element name="FinancialTransaction" type="{urn:hl7-org:v3}POCD_MT000040.FinancialTransaction_ext"/>
...
public class POCDMT000040Entry implements Cloneable{

    //private POCDMT000040Entry clonato = new POCDMT000040Entry();
    protected List<CS> realmCode;
    protected POCDMT000040InfrastructureRootTypeId typeId;
    protected List<II> templateId;
    @XmlElement(name = "FinancialTransaction")
    protected POCDMT000040FinancialTransactionExt financialTransaction;
    ...
    public POCDMT000040Entry copia(final POCDMT000040Entry vecchio) {
        POCDMT000040Entry nuovo = null;

        try {
            nuovo = (POCDMT000040Entry) this.clone();
            nuovo.setObservation(nuovo.getObservation().copia());
        } catch (CloneNotSupportedException ex) {
            Logger.getLogger(POCDMT000040Entry.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    /**
     * Recupera il valore della proprietà financialTransaction.
     *
     * @return possible object is {@link POCDMT000040FinancialTransactionExt }
     *
     */
    public POCDMT000040FinancialTransactionExt getFinancialTransaction() {
        return financialTransaction;
    }

    /**
     * Imposta il valore della proprietà financialTransaction.
     *
     * @param value allowed object is
     *     {@link POCDMT000040FinancialTransactionExt }
     *
     */
    public void setFinancialTransaction(POCDMT000040FinancialTransactionExt value) {
