    ...
    extends ST
{
    ...
    public JAXBElement asSerializable(String name, Object parent){
        return new JAXBElement(
                new QName(POCDMT000040ClinicalDocument.XSI_SCHEMA_LOCATION, name.toLowerCase(), ""),
                this.getClass(), parent.getClass(), this);
    }
}
