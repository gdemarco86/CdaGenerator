...
/**
 * <p>Classe Java per POCD_MT000040.Observation complex type.
 * 
...
public class POCDMT000040Observation implements Cloneable{
    ...
    public POCDMT000040Observation copia()
    {
        POCDMT000040Observation nuovo = null;
        try {
            nuovo = (POCDMT000040Observation) this.clone();
            nuovo.setCode(nuovo.getCode().copia());
    ...
    public List<ANY> getValue() {
     ...
     public void setValue( List<ANY> value) {
        this.value = value;
    }
    ...
    public void setInterpretationCode(List<CE> ic) {
    ...
    public void setPerformer(List<POCDMT000040Performer2> value) {
    ...
    public List<POCDMT000040EntryRelationship> getEntryRelationship() {
     ...
     public void setEntryRelationship(List<POCDMT000040EntryRelationship> value) {
    ...
    public void setReferenceRange(List<POCDMT000040ReferenceRange> rr) {
        referenceRange = rr;
    }
