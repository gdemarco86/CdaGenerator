...
public class POCDMT000040ClinicalDocument {
    ...
    public static String XSI_SCHEMA_LOCATION = "urn:hl7-org:v3";
    ...
    public void setRecordTarget(List<POCDMT000040RecordTarget> value)
    {
    ...
    public void setAuthor(List<POCDMT000040Author> value) {
        this.author = value;
    }
    ...
    public void setParticipant(List<POCDMT000040Participant1> value) {
    ...
    public void setInFulfillmentOf(List<POCDMT000040InFulfillmentOf> value){
    ...
    public void setDocumentationOf(List<POCDMT000040DocumentationOf> doc) {
        documentationOf = doc;
    }
    ...
    public List<POCDMT000040RelatedDocument> getRelatedDocument() {
     ...
     public void setRelatedDocument(List<POCDMT000040RelatedDocument> relDoc) {
        this.relatedDocument = relDoc;
    }
